...
import { selectTravelTimeInformation, selectInitialTravelInformation, selectInitialTravelDuration, selectEarthDistance} from '../store/slices/navSlice';
  ...
  return (
      ...
      <View style={styles.body}>
        ...
        <View style={styles.bottomBody}>
            <Text>Toplam Uzaklık: {parseFloat(earthDistance)+parseFloat(travelTimeInformation?.distance.text)} km</Text>
        </View>
