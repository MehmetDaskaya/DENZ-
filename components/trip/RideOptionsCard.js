...
const data = [
  {
    ...
    multiplier: 1.2,
    image:
      "https://raw.githubusercontent.com/Nerimb/DENZ-/main/utils/images/Vehicle1.1.png",
    speed: 15,
  },
  {
    id: "Saic-456",
    ...
    multiplier: 1.2,
    image:
      "https://raw.githubusercontent.com/Nerimb/DENZ-/main/utils/images/Vehicle2.1.png",
    speed: 10,
  },
  {
    id: "FerIBB",
    ...
    multiplier: 0.25,
    image:
      "https://raw.githubusercontent.com/Nerimb/DENZ-/main/utils/images/Vehicle3.1.png",
    speed: 12,
  },
];
        ...
        renderItem={({ item: { id, title, multiplier, image }, item }) => (
          ...
          >
            ...
            <View style={styles.info}>
              ...
              <Text style={{}}>
                {((earthDistance / item.speed) * 60).toFixed(1)} dakika
              </Text>
            </View>
            <Text style={styles.price}>
              {((earthDistance / item.speed) * 60 * item.multiplier).toFixed(1)}{" "}
              TL
            </Text>
          </TouchableOpacity>
        )}
