...
export const {setSignedIn, setOrigin, setDestination, setTravelTimeInformation, setInitialTravelInformation, setInitialTravelDuration, setEarthDistance, setSeaTravelInformation } = navSlice.actions;
...
export const selectInitialTravelInformation = (state) => state.nav.initialTravelInformation;
export const selectInitialTravelDuration = (state) => state.nav.initialTravelDuration;
export const selectEarthDistance = (state) => state.nav.earthDistance;
export const selectSeaTravelInformation = (state) => state.nav.seaTravelInformation;
